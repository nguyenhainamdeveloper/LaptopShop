    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <head>
                ...
                <meta name="description" content="LaptopShop - Admin Create Product" />
                <meta name="author" content="Nguyen Hai Nam" />
                                            ...
                                            <form:form method="post" action="/admin/product/create" class="row"
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    ...
                                                    <form:select class="form-select" path="target">
                                                        ...
                                                        <form:option value="STUDENT-OFFICE">Sinh viên - Văn phòng
                                                        </form:option>
